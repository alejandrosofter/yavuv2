...
export default async function handler(req, res) {
    const {id,campoId,sinUsuario,buscaPorUsuario,limite,pageSize,page,busca } = req.query
    ...
    const [salida,codigoSalida]=await handlerApiABM({wheres,orderBy,callbackCreate,pageSize,page,id,req, res,coleccion,campoId,sinUsuario,buscaPorUsuario,limite})
