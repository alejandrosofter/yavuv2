...
import { getTablas,mfindAll,getCantidadRegistros,getRegistro } from "../../../config/mongodb"
...
export default async function handler(req, res) {
    const { seleccionDesde,idOrigenDatos,textoRegistros,seleccionHasta,pkDesde,pkHasta } = req.body
