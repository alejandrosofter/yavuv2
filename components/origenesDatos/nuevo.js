...
import ModeloOrigenesDatos,{valoresIniciales} from "../../modelos/ModeloOrigenesDatos"
    ...
    if(!dataModulos)return <CircularProgress />
      ...
      modelo={ModeloOrigenesDatos} esNuevo={true} dataUsuario={dataUsuario} >
                ...
                <Grid sx={{pt:3}} md={12} container rowSpacing={2} spacing={2}>
                    ...
                    <Grid item md={5}><Input label="Nombre "  campo="nombre"/></Grid>
                    <Grid item md={3}><Input label="Host " campo="host"/></Grid>
                    <Grid item md={3}><Input label="Puerto " campo="port"/></Grid>
                    <Grid item md={4}><Input label="Usuario " campo="user"/></Grid>
                    <Grid item md={4}><Input label="Clave " campo="pass"/></Grid>
                    <Grid item md={4}><Input label="Db " campo="db"/></Grid>
                    <Grid item md={3}><SwitchFormik label="Es MongoDB? " campo="esMongo"/></Grid>
                    <Grid item md={3}><Input label="Es Defecto? " campo="esDefecto"/></Grid>
