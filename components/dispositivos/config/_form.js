...
<TabsFormik label="Configs" vistas={[
        ...
        {label:"Tipo de Equipos",nro:0,vista:
        <Grid item md={12}>
        <DataGridFormikItems label="Tipo de Equipos" Modelo={ModeloTipoEquipos} FormularioItem={FormTipoEquipos}  campo="itemsTipoEquipos" columns={[
    { field: 'nombre', headerName: 'Nombre',width: 150 },

    { field: 'cadaTiempoEnvia', headerName: 'Frecuencia',width: 100 },
