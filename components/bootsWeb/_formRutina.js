...
<Grid item md={5}><Input campo='accion' label="Accion" /></Grid>
<Grid item md={5}><Input campo='selector' label="selector" /></Grid>
<Grid item md={5}><Input campo='subAccion' label="Sub Accion" /></Grid>

<Grid item md={5}><Input campo='parametros' label="Parametro" /></Grid>
<Grid item md={2}><Switch campo='esEntrada' label="Es entrada" /></Grid>
