...
export default function FormGeneracionDeudas({setFieldValue,values,titulo,subTitulo,icono})
{
    ...
    const cambiaConcepto=id=>{
        ...
        if(itemConcepto){
            ...
            setFieldValue("conjunto",getDataObj(itemConcepto,"aplicaDeudaConjunto") )
            setFieldValue("calculoImporte",getDataObj(itemConcepto,'calculoImporte') )
            setFieldValue("fnDetalleConcepto",getDataObj(itemConcepto,'fnDetalleConcepto') )
            setFieldValue("fnDetalleExtra",getDataObj(itemConcepto,'fnDetalleExtra') )
            setFieldValue("fnLabelElemento",getDataObj(itemConcepto,'fnLabelElemento') )
