...
export default function FormGeneracionDeudas({setFieldValue,values,titulo,subTitulo,icono})
{
    ...
    const cambiaConcepto=id=>{
        ...
        if(itemConcepto){
            ...
            setFieldValue("fnDetalleExtra",'fnDetalleExtra' in itemConcepto?itemConcepto.fnDetalleExtra:"")
            setFieldValue("fnLabelElemento",'fnLabelElemento' in itemConcepto?itemConcepto.fnLabelElemento:"")
    ...
    return(
        <Stack>
            ...
            <Grid sx={{pt:1,mb:2}} md={12} container rowSpacing={2} spacing={2}>
                        ...
                        <Grid item md={2}><SelectEstaticFormik items={["PENDIENTE","GENERADO","ENVIADO"]}  label="ESTADO" campo="estado"/></Grid>
