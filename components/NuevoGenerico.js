...
export default function NuevoGenerico({preData,removeTitle,mod,callbackSuccess,modelo,valoresIniciales,children}){
  ...
  if(error)return error
    return(
      <Grid container>
        ...
        <_FormGenerico preData={preData} callbackSuccess={callbackSuccess} fnUpdate={add} modelo={modelo} 
