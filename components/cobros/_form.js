    ...
    const cambiaCliente=(cliente)=>{ 
      ...
      return (
            <Grid sx={{pt:2}} container >
                ...
                <Grid item md={3}><SelectAlgoliaFormik callbackchange={cambiaCliente} coleccionAlgolia="clientes" label="Cliente" campo="cliente"/></Grid>
                        <Grid item md={1}><SeleccionDeuda fnChange={cambianItemsDeuda} abre={openDeuda} cliente={clienteSeleccion}/></Grid>
                        <Grid item md={2}><SelectFecha  label="Fecha" campo="fecha"/></Grid>
                        <Grid item md={2}><SelectEstaticFormik items={["PENDIENTE","CANCELADA"]}  label="ESTADO" campo="estado"/></Grid>
                        
                </Grid>
                <Grid item md={8}> <ItemsCobro values={values} setFieldValue={setFieldValue}  deudas={deudas}/></Grid>
