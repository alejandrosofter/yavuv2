...
import {ModeloPrestacion,inicialesPrestacion} from "@modelos/ModeloPrestaciones"
    ...
    return(
        <Grid >
            <Stack>
                    ...
                    <Grid item md={1}><InterfazEventosWeb setFieldValue={setFieldValue} data={dataBoot} boots={mod.config?.itemsBootsWeb} /></Grid>
                        <Grid item md={2}><FechaTime label="Fecha"  campo="fecha"/></Grid>
                        <Grid item md={3}><SelectPacientes callbackchange={cambiaPaciente} /></Grid>
                        <Grid item md={3}><SelectObraSocial callbackchange={cambiaObraSocial} /></Grid>
                        ...
                        <ItemsModulo
                            ...
                            dataModulo={[]} columnas={[
                                ...
                                { field: 'label_prestacion',headerName: 'Prestacion', width: 290,  },
