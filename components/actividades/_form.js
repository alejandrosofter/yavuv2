...
import {
  ModeloItems,
  ModeloPeriodos,
  valoresInicialesPeriodos,
  valoresInicialesItems,
} from "../../modelos/ModeloActividades";
        ...
        vistas={[
          {
            label: `SUB-ACTIVIDADES (${
              values.subActividades ? values.subActividades.length : 0
            })`,
            nro: 0,
            vista: (
              <ItemsModulo
                setFieldValue={setFieldValue}
                campo="subActividades"
                data={values.subActividades}
                modelo={ModeloItems}
          ...
          {
            label: `PERIODOS (${values.periodos ? values.periodos.length : 0})`,
            nro: 1,
            vista: (
              <ItemsModulo
                setFieldValue={setFieldValue}
                campo="periodos"
                data={values.periodos}
                ...
                columnas={[
                  { field: "nombrePeriodo", headerName: "Nombre", width: 190 },
                  {
                    ...
                    width: 380,
                    renderCell: (params) =>
                      renderCellExpandData(params, fnRender),
                  },
